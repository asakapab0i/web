...
<div class="left">
	...
	<p>Currently, I’m starring in an international Swiffer campaign as a fashionable dirt-covered lady, studying with film director Dan Ireland through his master class, and developing a web series.</p>
	
	<div class="title">Links</div>
	<?=draw_img("/images/pdf.png", "audrey-resume.pdf", array("class"=>"icon", "target"=>"_blank"))?><a href="audrey-resume.pdf" target="_blank">Audrey's Resume</a> | <a href="http://www.imdb.com/name/nm3425473/">IMDB</a>
</div>
